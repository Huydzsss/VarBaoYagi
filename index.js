...
// Đọc file PDF
let dataBuffer = fs.readFileSync("./input/varSaoKe.pdf");
...
pdf(dataBuffer).then(function (data) {
  ...
  fs.writeFileSync("./output/varSaoKe.json", JSON.stringify(transactions, null, 4));
  ...
  const csv = transactions
    ...
    .join("\n");
  fs.writeFileSync("./output/varSaoKe.csv", "date,ct_num,money,desc,page\n" + csv);
});